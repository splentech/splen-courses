...
import {
  Box, Flex, Heading, Text, Button, Grid,
} from "@chakra-ui/react";
import { motion } from "framer-motion";
import Navlinks from "../components/layout/Navlink";
import { FaEnvelope, FaPhone, FaMapMarkerAlt, FaInstagram, FaFacebook, FaTwitter, FaLinkedin } from "react-icons/fa";
...
export default function Contact() {
  return (
    <Box bg="#0a0a0b" minH="100vh" color="white">
      ...
      {/* ambient glows */}
      <Box
        position="fixed" top="10%" left="5%" w="400px" h="400px"
        borderRadius="full" bg="blue.600" filter="blur(160px)" opacity={0.07}
        pointerEvents="none" zIndex={0}
      />
      <Box
        position="fixed" bottom="10%" right="5%" w="350px" h="350px"
        borderRadius="full" bg="purple.600" filter="blur(140px)" opacity={0.06}
        pointerEvents="none" zIndex={0}
      />

      <Box
        px={{ base: 4, md: 10 }} py={14}
        maxW="1100px" mx="auto"
      ...
      >
        ...
        >
          <Text
            color="blue.400" fontSize="xs" fontWeight="700"
            letterSpacing="0.15em" textTransform="uppercase" mb={3}
          >
          ...
          <Text mt={5} color="gray.400" maxW="560px" mx="auto" lineHeight={1.8}>
            Reach out for student programs, institutional training, corporate upskilling,
            or partnerships. We respond within 24 hours.
          </Text>
        </MotionBox>
        ...
        <Grid templateColumns={{ base: "1fr", md: "1.1fr 1fr" }} gap={8}>
          ...
          >
            ...
            <Heading size="lg" fontWeight="800" mb={4}>
              Join Splen Technologies Bootcamp 🚀
            </Heading>
            <Text color="gray.400" fontSize="md" lineHeight={1.8} mb={8}>
              Apply for instructor-led, project-based courses and unlock placement
              opportunities with industry-ready skills.
            </Text>
          ...
          <Flex direction="column" gap={5}>
            ...
            >
              ...
              <Text color="gray.400" fontSize="sm" lineHeight={1.8}>
                Splen Technologies<br />
                Technology &amp; Training Office<br />
                Chandigarh, India
              </Text>
            </MotionBox>
              ...
              {[
                ...
                <Flex key={i} align="center" gap={2} mb={2}>
                  <Box
                    ...
                    flexShrink={0}
                  />
                  <Text color="gray.400" fontSize="sm" dangerouslySetInnerHTML={{ __html: item }} />
                </Flex>
              ))}
            </MotionBox>
            ...
            >
              ...
              <Flex gap={4}>
                {[
                  ...
                  <Box
                    as="a" key={label} href={href} target="_blank" rel="noopener noreferrer"
                    w="36px" h="36px"
                    bg="rgba(79,110,247,0.12)"
                    border="1px solid rgba(79,110,247,0.25)"
                    borderRadius="lg"
                    display="flex" alignItems="center" justifyContent="center"
                    color="blue.400" fontSize="14px"
