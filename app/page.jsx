  ...
  return (
    <Box bg="#0a0a0b" color="white" overflow="hidden">
      ...
      <Box ref={ref} position="relative" minH="90vh" overflow="hidden">
        {/* ambient glow orbs */}
        <Box
          position="absolute" top="8%" left="12%" w="500px" h="500px"
          borderRadius="full" bg="blue.600" filter="blur(140px)" opacity={0.1}
          style={{ animation: "pulse-glow 7s ease-in-out infinite" }}
          pointerEvents="none"
        />
        <Box
          position="absolute" bottom="15%" right="8%" w="350px" h="350px"
          borderRadius="full" bg="purple.600" filter="blur(120px)" opacity={0.09}
          style={{ animation: "pulse-glow 9s ease-in-out infinite 3s" }}
          pointerEvents="none"
        />

        <Flex
          minH="90vh" align="center" justify="center" direction="column"
          textAlign="center" px={6} position="relative" zIndex={1}
        >
          {/* badge */}
          <MotionBox
          ...
          <MotionBox style={{ y }}>
            ...
            >
              ...
              {" "}Skillset{" "}
              <Text as="span" color="white">That Matters</Text>
            </Heading>
          </MotionBox>
          ...
          >
            <Text mt={6} color="gray.400" fontSize={{ base: "md", md: "lg" }} lineHeight={1.8}>
              Splen Technologies delivers structured training through live online and offline
              programs. Learn with expert mentors, build real-world projects, and gain
              job-ready skills aligned with current industry demands.
            </Text>
          </MotionBox>
        ...
        <Box maxW="1200px" mx="auto">
          ...
          >
            ...
            <Text mt={4} color="gray.400" maxW="580px" mx="auto" lineHeight={1.8}>
              Our comprehensive curriculum covers the most in-demand technology domains
              to prepare you for the current job market.
            </Text>
          </MotionBox>
            ...
            {domains.map((domain, i) => (
              ...
              >
                <Box
                  ...
                  color="blue.400" fontSize="18px" mb={4}
                >
                  <domain.icon />
                </Box>
      ...
      <Box py={28} position="relative" overflow="hidden">
        <Box
          ...
          w="700px" h="400px"
          bg="blue.600" filter="blur(160px)" opacity={0.07}
        ...
        >
          ...
          <Text color="gray.400" mb={8} maxW="480px" mx="auto" lineHeight={1.8}>
            Whether you&apos;re a student exploring tech or a professional upskilling,
