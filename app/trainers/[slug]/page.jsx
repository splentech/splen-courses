...
export default function TrainerPage({ params }) {
  ...
  return (
    <Box bg="#0a0a0b" color="white" minH="100vh">
      ...
      {/* ambient glow */}
      <Box
        position="fixed" top="15%" right="10%" w="350px" h="350px"
        borderRadius="full" bg="purple.600" filter="blur(140px)" opacity={0.07}
      ...
      <Box maxW="860px" mx="auto" px={{ base: 4, md: 6 }} py={14} position="relative" zIndex={1}>
        ...
        <Link href="/explore">
          <Button
            mb={8} size="sm" variant="outline"
            borderColor="rgba(255,255,255,0.15)" color="gray.400"
        ...
        >
          ...
          <Box textAlign={{ base: "center", md: "left" }}>
            ...
            <Text color="gray.400" mb={1}>Senior Instructor &bull; {trainer.experience}</Text>
            <Text fontSize="sm" color="gray.500">
              ⭐ 4.8 Rating &bull; 1200+ Students &bull; 5+ Courses
            </Text>
          </Box>
        </Flex>
        ...
        <Box
          mb={6} p={6}
          bg="#141418" borderRadius="xl"
          border="1px solid rgba(255,255,255,0.07)"
        >
          <Heading size="sm" mb={3} color="gray.300" textTransform="uppercase" letterSpacing="0.1em">
            About
          </Heading>
