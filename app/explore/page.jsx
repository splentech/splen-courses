...
import {
  Box, Heading, Input, Grid, Text, Button, Flex, InputGroup,
  InputLeftElement,
...
export default function Explore() {
  ...
  return (
    <Box bg="#0a0a0b" minH="100vh" color="white">
      ...
      {/* ambient glow */}
      <Box
        position="fixed" top="20%" left="5%" w="400px" h="400px"
        borderRadius="full" bg="blue.600" filter="blur(160px)" opacity={0.06}
